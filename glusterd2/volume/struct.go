...
func NewBrickEntries(bricks []api.BrickReq, volName, volfileID string, volID uuid.UUID, pT brick.ProvisionState) ([]brick.Brickinfo, error) {
	...
	for _, b := range bricks {
		...
		binfo.ProvisionType = pT
		if pT.IsAutoProvisioned() {
